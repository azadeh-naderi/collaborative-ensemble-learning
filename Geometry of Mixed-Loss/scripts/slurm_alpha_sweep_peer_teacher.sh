#!/bin/bash
#SBATCH --job-name=geo-alpha-peer
#SBATCH --output=logs/geometry_alpha_peer_%A_%a.out
#SBATCH --error=logs/geometry_alpha_peer_%A_%a.err
...
OUT_DIR="Geometry of Mixed-Loss/results/alpha_sweep_peer_teacher/alpha${ALPHA_STR}_seed${SEED}"
...
echo " Seed       : ${SEED}"
echo " Output     : ${OUT_DIR}"
echo " (mutual peer co-training, no CE-pretrained teacher)"
echo "================================================"
