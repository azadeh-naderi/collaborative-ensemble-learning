#!/bin/bash
#SBATCH --job-name=celnet-div-dml
#SBATCH --output=logs/diversity_dml_%j.out
#SBATCH --error=logs/diversity_dml_%j.err
...
OUT_DIR="${OUT_DIR:-results/diversity_dml_${SLURM_JOB_ID}}"
