#!/bin/bash
#SBATCH --job-name=celnet-div-ind
#SBATCH --output=logs/diversity_indep_%j.out
#SBATCH --error=logs/diversity_indep_%j.err
...
OUT_DIR="${OUT_DIR:-results/diversity_independent_${SLURM_JOB_ID}}"
