#!/bin/bash
#SBATCH --job-name=celnet-div-kd
#SBATCH --output=logs/diversity_tradkd_%j.out
#SBATCH --error=logs/diversity_tradkd_%j.err
...
OUT_DIR="${OUT_DIR:-results/diversity_trad_kd_${SLURM_JOB_ID}}"
